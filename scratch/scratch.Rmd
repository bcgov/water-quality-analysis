...
# TODO - double check list of stations, there are several not in the MoE list 
# of fed-prov stations but show up in the data.
...
# TODO - make a complete monthly df to store in another column. See scratch-mk.Rmd
...
fraser_hope_arsenic <- filter(bc_nested, SITE_NO == "BC08MF0001", 
